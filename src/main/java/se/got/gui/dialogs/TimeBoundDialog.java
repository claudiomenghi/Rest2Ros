...
import se.got.constraints.LowerTimeBound;
...
{   
    ...
    private void initComponents() {
        ...
        fUpperInterval = new se.got.gui.util.TimeTextField();
        fUpperTime = new se.got.gui.util.TimeTextField();
        fLowerTime = new se.got.gui.util.TimeTextField();
        fLowerInterval = new se.got.gui.util.TimeTextField();
    ...
    private se.got.gui.util.TimeTextField fLowerInterval;
    private javax.swing.JRadioButton fLowerLimit;
    private se.got.gui.util.TimeTextField fLowerTime;
    ...
    private se.got.gui.util.TimeTextField fUpperInterval;
    private javax.swing.JRadioButton fUpperLimit;
    private se.got.gui.util.TimeTextField fUpperTime;
