 ...
 */
package se.got.gui.panels.pattern;
...
public class PatternPanel extends javax.swing.JPanel implements PatternPanelFeatures
{
    ...
    private void initComponents() {
        ...
        fUniversality = new se.got.gui.panels.pattern.occurrence.ScrollableUniversalityPanel();
        fAbsence = new se.got.gui.panels.pattern.occurrence.ScrollableAbsencePanel();
        fExistence = new se.got.gui.panels.pattern.occurrence.ScrollableExistencePanel();
        fBoundedExistence = new se.got.gui.panels.pattern.occurrence.ScrollableBoundedExistencePanel();
        fTransientState = new se.got.gui.panels.pattern.occurrence.ScrollableTransientStatePanel();
        fSteadyState = new se.got.gui.panels.pattern.occurrence.ScrollableSteadyStatePanel();
        fMinimumDuration = new se.got.gui.panels.pattern.occurrence.ScrollableMinimumDurationPanel();
        fMaximumDuration = new se.got.gui.panels.pattern.occurrence.ScrollableMaximumDurationPanel();
        fRecurrence = new se.got.gui.panels.pattern.occurrence.ScrollableRecurrencePanel();
        fOrder = new javax.swing.JPanel();
        fOrderPattern = new javax.swing.JTabbedPane();
        fPrecedence = new se.got.gui.panels.pattern.order.ScrollablePrecedencePanel();
        fPrecedenceChain1N = new se.got.gui.panels.pattern.order.ScrollablePrecedenceChain1NPanel();
        fPrecedenceChainN1 = new se.got.gui.panels.pattern.order.ScrollablePrecedenceChainN1Panel();
        fUntil = new se.got.gui.panels.pattern.order.ScrollableUntilPanel();
        fResponse = new se.got.gui.panels.pattern.order.ScrollableResponsePanel();
        fResponseChain1N = new se.got.gui.panels.pattern.order.ScrollableResponseChain1NPanel();
        fResponseChainN1 = new se.got.gui.panels.pattern.order.ScrollableResponseChainN1Panel();
        fResponseInveriance = new se.got.gui.panels.pattern.order.ScrollableResponseInveriancePanel();
    ...
    private se.got.gui.panels.pattern.occurrence.ScrollableAbsencePanel fAbsence;
    private se.got.gui.panels.pattern.occurrence.ScrollableBoundedExistencePanel fBoundedExistence;
    private javax.swing.JTabbedPane fCategories;
    private se.got.gui.panels.pattern.occurrence.ScrollableExistencePanel fExistence;
    private se.got.gui.panels.pattern.occurrence.ScrollableMaximumDurationPanel fMaximumDuration;
    private se.got.gui.panels.pattern.occurrence.ScrollableMinimumDurationPanel fMinimumDuration;
    ...
    private se.got.gui.panels.pattern.order.ScrollablePrecedencePanel fPrecedence;
    private se.got.gui.panels.pattern.order.ScrollablePrecedenceChain1NPanel fPrecedenceChain1N;
    private se.got.gui.panels.pattern.order.ScrollablePrecedenceChainN1Panel fPrecedenceChainN1;
    private se.got.gui.panels.pattern.occurrence.ScrollableRecurrencePanel fRecurrence;
    private se.got.gui.panels.pattern.order.ScrollableResponsePanel fResponse;
    private se.got.gui.panels.pattern.order.ScrollableResponseChain1NPanel fResponseChain1N;
    private se.got.gui.panels.pattern.order.ScrollableResponseChainN1Panel fResponseChainN1;
    private se.got.gui.panels.pattern.order.ScrollableResponseInveriancePanel fResponseInveriance;
    private se.got.gui.panels.pattern.occurrence.ScrollableSteadyStatePanel fSteadyState;
    private se.got.gui.panels.pattern.occurrence.ScrollableTransientStatePanel fTransientState;
    private se.got.gui.panels.pattern.occurrence.ScrollableUniversalityPanel fUniversality;
    private se.got.gui.panels.pattern.order.ScrollableUntilPanel fUntil;
