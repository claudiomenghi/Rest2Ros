...
import se.got.sel.patterns.order.PrecedenceChain1N;
...
public class PrecedenceChain1NPanel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    ...
    private void initComponents() {
        ...
        fS1 = new se.got.gui.util.EventComboBox();
        ...
        fS2 = new se.got.gui.util.EventComboBox();
    ...
    private se.got.gui.util.EventComboBox fS1;
    private se.got.gui.util.EventComboBox fS2;
